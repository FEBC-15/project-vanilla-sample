...
- api/dbinit/team-bruno, api/dbinit/team-nike 폴더의 파일을 팀에 맞게 수정 후 [DB 초기화](https://fesp-api.koyeb.app/market/apidocs/#/%EC%8B%9C%EC%8A%A4%ED%85%9C/post_db_init) 작업 실행

### 5.2 팀 프로젝트 API 서버 테스트
- 팀 프로젝트 폴더에서 [4.10 샘플 Bruno 파일 다운로드] 작업 수행
- 환경변수 prod의 client-id는 각 팀에게 부여된 값 `febc15-vanilla팀번호-ecad`으로 수정
