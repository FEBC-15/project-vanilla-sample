...
- Repositories > New repository
  - Repository name: `project-vanilla-my`
  - Description: FrontEnd BootCamp 15기 my 바닐라 프로젝트 
  - Public 선택
  - Create repository
...
```sh
npm create vite@latest project-vanilla-my
```
...
│  ● Yes / ○ No
│
◇  Scaffolding project in C:/febc15/project-vanilla-my...
│
...
- project-vanilla-my 폴더에(프로젝트 루트) vite.config.js 파일 생성
```js
...
```sh
git remote add origin https://github.com/계정/project-vanilla-my.git
```
...
- `GitHub` 선택
- project-vanilla-my 레포지토리 선택후 `Install` 클릭
- project-vanilla-my 선택
